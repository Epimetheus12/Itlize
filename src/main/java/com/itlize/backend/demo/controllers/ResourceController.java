...
public class ResourceController {
    ...
    @GetMapping("/all")
    public ResponseEntity<?> allResourceByUserId() {
    ...
    public ResponseEntity<?> deleteById(@RequestParam("id") int id){
        return new ResponseEntity< >(resourceService.deleteOneById(id), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> createOne(@RequestParam("name") String name,
        ...
        r.setCreatedTime(new Timestamp(new Date().getTime()));
        r.setName(name);
